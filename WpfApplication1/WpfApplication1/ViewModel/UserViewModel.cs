    ...
    class UserViewModel
    {
        ...
        public UserViewModel()
        {
            _UsersList = new List<User>
            {
                ...
                new User{UserId=9,FirstName="Gupta",LastName="Taneja",City="Delhi", State="DEL", Country="INDIA"},
                new User{UserId=9,FirstName="Narayana",LastName="Swamy",City="Bangalore", State="KA", Country="INDIA"},
                new User{UserId=9,FirstName="Jeevan",LastName="Prasad",City="Sivakasi", State="TN", Country="INDIA"},
                new User{UserId=9,FirstName="Sangavi",LastName="R",City="Kalpakkam", State="TN", Country="INDIA"},
                new User{UserId=9,FirstName="Yami",LastName="Singh",City="Delhi", State="DEL", Country="INDIA"},
            };
        }
